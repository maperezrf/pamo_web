...
class fileForm(forms.Form):
    file = forms.FileField( validators=[FileExtensionValidator(allowed_extensions=['xlsx'])], widget=forms.FileInput(attrs={'class': 'form-control form-control-sm file_upload'}))
