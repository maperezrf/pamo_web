...
NIT_SODIMAC = config("NIT_SODIMAC")
...
# ENVIA
URL_ENVIA = config("URL_ENVIA")
TOKEN_ENVIA = config("TOKEN_ENVIA")

# CRECENCIALES EMAIL ENVIO DE CORREOS
EMAIL_HOST_USER = config("EMAIL_HOST_USER")

PASSWORD_MAIL = config("PASSWORD_MAIL")

NOTIFICATIONS_RECIPENTS = config("NOTIFICATIONS_RECIPENTS").split(",")
